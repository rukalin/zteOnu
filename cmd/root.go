...
func init() {
	rootCmd.PersistentFlags().StringVarP(&user, "user", "u", "CUAdmin", "factory mode auth username")
	rootCmd.PersistentFlags().StringVarP(&passwd, "pass", "p", "CUAdmin", "factory mode auth password")
